...
char_size = 128
z_dim = 128
train_data_path = "./news2016zh_train.json"
...
class OurBidirectional(OurLayer):
    ...
    def __init__(self, layer, **args):
        ...
        self.forward_layer._name = 'forward_' + self.forward_layer._name
        self.backward_layer._name = 'backward_' + self.backward_layer._name
